...
#'*|--| Date: 2025-09-18                                                        |*
#'*|----------------------------------------------------------------------------|*
#'*|--| Conjunto de datos: Phase1=>6_c2e_conflicts.dta                                    |*
#'*|----------------------------------------------------------------------------|*
...
preprocMessage("Phase1=>6_c2e_conflicts.dta")

# Lectura del conjunto de datos
data=read_dta(file.path(data_path,"Phase1/6_c2e_conflicts.dta"))

# Carga del archivo de clasificación de variables
variable_classification=read_excel(path="01.Classificacao de variaveis/Phase1_VarClas.xlsx",sheet  = "6_c2e_conflicts") %>% select(Name:Questions)

#Carga del archivo que contiene las etiquetas de las variables, tanto las antiguas como las nuevas
variable_labels=read_excel(path="07.Descripcion de archivos/Phase1_labels.xlsx",sheet ="6_c2e_conflicts")
...
write_dta(data,"03.Datos preprocesados/Phase1/6_c2e_conflicts_proc.dta")
