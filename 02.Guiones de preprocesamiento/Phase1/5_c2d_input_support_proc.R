...
#'*|--| Date: 2025-09-18                                                        |*
#'*|----------------------------------------------------------------------------|*
#'*|--| Conjunto de datos: Phase1=>5_c2d_input_support.dta                                |*
#'*|----------------------------------------------------------------------------|*
...
preprocMessage("Phase1=>5_c2d_input_support.dta")

# Lectura del conjunto de datos
data=read_dta(file.path(data_path,"Phase1/5_c2d_input_support.dta"))

# Carga del archivo de clasificación de variables
variable_classification=read_excel(path="01.Classificacao de variaveis/Phase1_VarClas.xlsx",sheet  = "5_c2d_input_support") %>% select(Name:Questions)

#Carga del archivo que contiene las etiquetas de las variables, tanto las antiguas como las nuevas
variable_labels=read_excel(path="07.Descripcion de archivos/Phase1_labels.xlsx",sheet ="5_c2d_input_support")
...
write_dta(data,"03.Datos preprocesados/Phase1/5_c2d_input_support_proc.dta")
