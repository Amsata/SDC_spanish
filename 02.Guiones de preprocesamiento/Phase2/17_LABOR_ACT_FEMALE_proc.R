...
#'*|--| Date: 2025-09-18                                                        |*
#'*|----------------------------------------------------------------------------|*
#'*|--| Conjunto de datos: Phase2=>17_LABOR_ACT_FEMALE.dta                                |*
#'*|----------------------------------------------------------------------------|*
...
preprocMessage("Phase2=>17_LABOR_ACT_FEMALE.dta")

# Lectura del conjunto de datos
data=read_dta(file.path(data_path,"Phase2/17_LABOR_ACT_FEMALE.dta"))

# Carga del archivo de clasificación de variables
variable_classification=read_excel(path="01.Classificacao de variaveis/Phase2_VarClas.xlsx",sheet  = "17_LABOR_ACT_FEMALE") %>% select(Name:Questions)

#Carga del archivo que contiene las etiquetas de las variables, tanto las antiguas como las nuevas
variable_labels=read_excel(path="07.Descripcion de archivos/Phase2_labels.xlsx",sheet ="17_LABOR_ACT_FEMALE")
...
write_dta(data,"03.Datos preprocesados/Phase2/17_LABOR_ACT_FEMALE_proc.dta")
