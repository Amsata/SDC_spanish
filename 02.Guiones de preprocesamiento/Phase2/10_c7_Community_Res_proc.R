...
#'*|--| Date: 2025-09-18                                                        |*
#'*|----------------------------------------------------------------------------|*
#'*|--| Conjunto de datos: Phase2=>10_c7_Community_Res.dta                                |*
#'*|----------------------------------------------------------------------------|*
...
preprocMessage("Phase2=>10_c7_Community_Res.dta")

# Lectura del conjunto de datos
data=read_dta(file.path(data_path,"Phase2/10_c7_Community_Res.dta"))

# Carga del archivo de clasificación de variables
variable_classification=read_excel(path="01.Classificacao de variaveis/Phase2_VarClas.xlsx",sheet  = "10_c7_Community_Res") %>% select(Name:Questions)

#Carga del archivo que contiene las etiquetas de las variables, tanto las antiguas como las nuevas
variable_labels=read_excel(path="07.Descripcion de archivos/Phase2_labels.xlsx",sheet ="10_c7_Community_Res")
...
write_dta(data,"03.Datos preprocesados/Phase2/10_c7_Community_Res_proc.dta")
